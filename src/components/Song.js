    ...
    return (
      <>
        <Wrapper>
          ...
          <Icon background="black" size="13px" width="25px" height="25px" color="white" BorderRadius="50%" onClick={()=>share({title:"Musico",url:window.location.href,text:"Listen To "+data.songs[0].title})}><i class="fa fa-share-alt"></i></Icon>
